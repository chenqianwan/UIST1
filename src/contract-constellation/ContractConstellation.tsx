...
import reneStageAData from '../../docs/templates/reneHouseTemplate.stage_a.json';
import reneStageBData from '../../docs/templates/reneHouseTemplate.stage_b.json';
import testAbStageAData from '../../docs/templates/test_ab.stage_a.json';
import testAbStageBData from '../../docs/templates/test_ab.stage_b.json';
import testNewStageAData from '../../docs/templates/test_new.stage_a.json';
import testNewStageBData from '../../docs/templates/test_new.stage_b.json';
import testNewStageCData from '../../docs/templates/test_new.stage_c.json';
import text2AbStageAData from '../../docs/templates/text2_ab.stage_a.json';
import text2AbStageBData from '../../docs/templates/text2_ab.stage_b.json';
import text2AbStageCData from '../../docs/templates/text2_ab.stage_c.json';
import text2AbStageAChineseData from '../../docs/templates/text2_ab.stage_a.chinese.json';
import text2AbStageBChineseData from '../../docs/templates/text2_ab.stage_b.chinese.json';
import text2AbStageCChineseData from '../../docs/templates/text2_ab.stage_c.chinese.json';
import testNewStageAChineseData from '../../docs/templates/test_new.stage_a.chinese.json';
import testNewStageBChineseData from '../../docs/templates/test_new.stage_b.chinese.json';
import testNewStageCChineseData from '../../docs/templates/test_new.stage_c.chinese.json';
import enterpriseSaasMsaStageAData from '../../docs/templates/enterprise_saas_msa.stage_a.json';
import enterpriseSaasMsaStageBData from '../../docs/templates/enterprise_saas_msa.stage_b.json';
